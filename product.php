...
$hash = "product";
$count = DbQuery("SELECT COUNT(*) FROM {$DB_PREFIX}products");
?>

<div id="actions">
	<h1><?php echo M_PRODS_TXT; ?></h1>
	<a href="#product/edit" class="addLink" onclick="return loadcontent('product/edit')"><?php echo ADD_TXT; ?></a>
</div>
