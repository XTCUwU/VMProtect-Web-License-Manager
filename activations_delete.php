...
{
    DbQuery("DELETE FROM {$DB_PREFIX}activations WHERE id=" . Sql($_REQUEST["id"])) or die("Error:" . mysqli_error($mysqli_link));
}
else
{
?>

<h1><?php echo ACT_DELETE_TXT; ?></h1>
<?php echo ACT_DELMSG_TXT; ?>
<br/><br/>
<form method="post" action="activations_delete.php">
